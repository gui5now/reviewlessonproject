...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../public/css/area_aluno.css">
...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Área do Aluno</a></h1>
  ...
  <section id="intro">
    <div class="intro-container">
      <div class="band">
        <div class="item-1">
            <a href="escolher_horario.html" class="card">
              <div class="thumb" style="background-image: url('../../public/img/portugues.jpg')"></div>
              <article>
                <h1><strong>Português</strong></h1>
          ...
          <div class="item-2">
            <a href="escolher_horario.html" class="card">
              <div class="thumb" style="background-image: url('../../public/img/matematica.jpg')"></div>
              <article>
                <h1><strong>Matemática</strong></h1>
         ...
         <div class="item-3">
            <a href="escolher_horario.html" class="card">
              <div class="thumb" style="background-image: url('../../public/img/ciencias.jpg')"></div>
              <article>
                <h1><strong>Ciências</strong></h1>
         ...
         <div class="item-4">
            <a href="escolher_horario.html" class="card">
              <div class="thumb" style="background-image: url('../../public/img/fisica.jpg')"></div>
              <article>
                <h1><strong>Física</strong></h1>
         ...
         <div class="item-1">
            <a href="#" class="card">
              <div class="thumb" style="background-image: url('../../public/img/biologia.jpg')"></div>
              <article>
                <h1><strong>Biologia</strong></h1>
         ...
         <div class="item-1">
            <a href="#" class="card">
              <div class="thumb" style="background-image: url('../../public/img/quimica.png')"></div>
              <article>
                <h1><strong>Química</strong></h1>
         ...
         <div class="item-1">
            <a href="#" class="card">
              <div class="thumb" style="background-image: url('../../public/img/geografia.jpg')"></div>
              <article>
                <h1><strong>Geografia</strong></h1>
         ...
         <div class="item-1">
            <a href="#" class="card">
              <div class="thumb" style="background-image: url('../../public/img/historia.jpg')"></div>
              <article>
